...
# Parallelism_abs抽象基类，提供了并行处理的基本框架
...
# Parallelism类是一个多进程映射类，它继承自Parallelism_abs抽象基类，提供了并行处理的功能
...
# Parallelism_Thread类是一个多线程映射类，它继承自Parallelism_abs抽象基类，提供了并行处理的功能
